...
/* Link active work */
const linkWork = d.querySelectorAll('.work__item');
...
const getCurrentTheme = () => (d.body.classList.contains(lightTheme) ? 'dark' : 'light')
...
if (selectedTheme) {
  ...
  d.body.classList[selectedTheme === 'dark' ? 'add' : 'remove'](lightTheme)
...
themeButton.addEventListener('click', () => {
  ...
  d.body.classList.toggle(lightTheme)
